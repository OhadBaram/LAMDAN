...
export const CardHeader: React.FC<CardHeaderProps> = ({ children, className, ...props }) => <div className={`p-4 border-b border-[var(--border)] ${className || ''}`} {...props}>{children}</div>;
export const CardTitle: React.FC<CardTitleProps> = ({ children, className, ...props }) => <h3 className={`font-medium text-lg text-[var(--text-primary)] ${className || ''}`} {...props}>{children}</h3>;
...
export const CardContent: React.FC<CardContentProps> = ({ children, className, ...props }) => <div className={`p-4 ${className || ''}`} {...props}>{children}</div>;
