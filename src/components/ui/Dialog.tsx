...
export const DialogTitle: React.FC<DialogTitleProps> = ({ children, className, ...props }) => <h2 className={`text-lg font-medium text-[var(--text-primary)] ${className || ''}`} {...props}>{children}</h2>;
