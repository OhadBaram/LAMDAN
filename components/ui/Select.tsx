...
export const Select: React.FC<SelectProps> = (props) => {
    ...
    const baseClassName = `px-3 py-2.5 rounded-lg border bg-slate-50 dark:bg-slate-700 border-slate-300 dark:border-slate-600 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none w-full transition-colors duration-150 ease-in-out ${className || ''}`;
